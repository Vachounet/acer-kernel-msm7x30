...
{
#if defined(CONFIG_MACH_ACER_A4) || defined(CONFIG_MACH_ACER_A5)
	unsigned id1 = ACER_SMSM_PROC_CMD_SD_UPDATE;
	unsigned id2 = ACER_SDDL_INVALID;

	pr_info("%s: prepare to restart device.\r\n", __FUNCTION__);
	msm_rpcrouter_close();
